...
const AttrTitleIcon = ({item}:any) => {
    return (
        <div>
            <div className={'flex items-center gap-x-2 border py-4 px-6'}>
                <div className={'text-gray-400'}>
                    {item.icon ?
                        <Image width={36} height={36} src={item.icon}
                               alt="icon"/>
                        :
                        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 32 32" height="36"
                             width="36"
                ...
                <h2 className={'text-[21px]   font-semibold'}>{item.key}</h2>
            </div>
        </div>
    );
};

export default AttrTitleIcon;